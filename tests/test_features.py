...
class FeatureTests(unittest.TestCase):
    ...
    def test_build_asset_post_mappings_supports_rule_and_semantic_matches(self) -> None:
            ...
            [
                {
                    ...
                    "semantic_primary_asset": "NVDA",
                    "semantic_asset_targets": "NVDA,SMH,QQQ",
                    "semantic_confidence": 0.82,
                    "semantic_summary": "Markets narrative with NVDA focus.",
                ...
                },
                {
                    ...
                    "semantic_primary_asset": "XLE",
                    "semantic_asset_targets": "XLE,SPY",
                    "semantic_confidence": 0.76,
                    "semantic_summary": "Trade narrative with energy focus.",
                    "semantic_schema_version": "narrative-v1",
                    "semantic_provider": "heuristic-cache",
        ...
        self.assertEqual(str(nvda_post["semantic_primary_asset"]), "NVDA")
        self.assertIn("NVDA", str(nvda_post["semantic_asset_targets"]))
        ...
        asset_post_mappings = pd.DataFrame(
            [
                ...
                },
                {
                    ...
                    "semantic_primary_asset": "SPY",
                    "semantic_asset_targets": "SPY,XLE",
                    "semantic_confidence": 0.74,
                    "semantic_summary": "Trade narrative with broad-market focus.",
                    "semantic_schema_version": "narrative-v1",
                    "semantic_provider": "heuristic-cache",
                    "is_active_tracked_account": False,
                    "tracked_discovery_score": 0.0,
